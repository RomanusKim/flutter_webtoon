...
class _DetailScreenState extends State<DetailScreen> {
  ...
  //initState >> StatefulWidgets 사용을 위해
  @override
  void initState() {
    super.initState();
            ...
            children: [
                  ...
                  Hero(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(blurRadius: 15, offset: Offset(10, 10), color: Colors.black.withOpacity(0.5)),
                        ],
                      ),
                      child: Image.network(
                        widget.thumb,
              ...
              FutureBuilder(
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    return Column(
                      children: [for (var episode in snapshot.data!) Episode(episode: episode, webtoonId: widget.id)],
                    );
                  }
                  return Container();
                },
